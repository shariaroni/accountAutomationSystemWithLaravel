...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600"><?php echo e(__('পাসওয়ার্ড মনে রাখুন')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm text-red-500 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
                    <?php echo e(__('পাসওয়ার্ড ভুলে গেছেন?')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\da\resources\views/auth/login.blade.php ENDPATH**/ ?>