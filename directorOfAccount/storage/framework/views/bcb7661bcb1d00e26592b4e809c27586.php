                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <?php if(Route::has('login')): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(route('logout')); ?>">লগ আউট</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(route('login')); ?>">ইনডেক্স</a>
                                    </li>
...
<footer class="page-footer font-small blue">
  ...
  <!-- Footer -->
</html><?php /**PATH C:\xampp\htdocs\da\resources\views/welcome.blade.php ENDPATH**/ ?>